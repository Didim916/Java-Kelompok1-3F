...
public class DataKasir extends javax.swing.JFrame {
    ...
    private void IdOtomatis(){
        try {
            ...
            String sql1 = "select * from kasir order by id desc";
            ...
            if(rs.next()){
                ...
                txtId.setText("wrb" + nol + an); 
            } else{
                txtId.setText("wrb001");
            }
        } catch (Exception e) {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(33, 33, 33)
                                .addComponent(txtNohp, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        EditKasir ek = new EditKasir();
        ek.id = txtId.getText();
        ek.nama = txtNama.getText();
        ek.username = txtUsername.getText();
        ek.password = txtPassword.getText();
        ek.nohp = txtNohp.getText();
        try {
            ek.simpan();
    ...
    private void tblTampilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTampilMouseClicked
        ...
        txtUsername.setText(tblTampil.getModel().getValueAt(row, 2).toString());
        txtPassword.setText(tblTampil.getModel().getValueAt(row, 3).toString());
        txtNohp.setText(tblTampil.getModel().getValueAt(row, 4).toString());
