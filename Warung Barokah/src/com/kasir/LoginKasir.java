...
public class LoginKasir extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "SELECT * FROM kasir WHERE username='" + txtUsername.getText()
            ...
            if (r.next()) {
                ...
                DashKasir a = new DashKasir();
                a.setVisible(true);
            }else{
                JOptionPane.showMessageDialog(null, "Perikisa Username dan Password anda...");
